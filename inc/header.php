        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right icons">
                    ...
                    <li><a class="nav-link" href="camera.php">
                    ...
                    echo '<a href="register"><button type="button" class="btn">Register</button></a>
                            ';}
                    if (!isset($_SESSION['email']) && basename($_SERVER['PHP_SELF']) != 'login.php'){
                        echo '<a href="login"><button type="button" class="btn">Login</button></a>
                            ';}
                    ?>
                </ul>
            </div><!-- /.navbar-collapse -->
